    ...
    <main className="page-shell">
      <header className="site-header">
        ...
        <div className="header-actions">
          ...
          <button className={`cart-button${cartButtonPop ? " pop" : ""}`} onClick={() => setCartOpen(true)} type="button" aria-label="Ver carrito">
        ...
        <div className="mobile-nav-overlay" onClick={() => setMobileNavOpen(false)}>
          <nav className="mobile-nav-panel" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mobile-nav-links">
              {[
                ["inicio", "Inicio", <svg key="i" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>],
                ["catalogo", "Catálogo", <svg key="c" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>],
                ["sobre-nosotros", "Sobre nosotros", <svg key="s" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg>],
                ["contacto", "Contacto", <svg key="ct" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>],
              ].map(([v, l, icon]) => (
                <button
                  key={v}
          ...
          <>
            ...
            <section className="welcome-section">
              ...
              <p className="welcome-tagline">
                Muebles y artículos del hogar · Zona sur del GBA
              </p>
              <p className="welcome-years">Empresa familiar · +8 años de trayectoria</p>

              {/* Botones de acción */}
              <div className="welcome-actions">

                {/* Comprar online */}
                <button className="welcome-btn welcome-btn-catalog" onClick={() => navigateTo("catalogo")} type="button">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                ...
                {/* WhatsApp */}
                <a
                  className="welcome-btn welcome-btn-wsp"
                  href={buildContactLink("Hola! Los encontré en la página web y quiero consultar sobre sus productos 😊")}
                  target="_blank"
                  rel="noreferrer"
                >
      ...
      <section className="help-strip">
        <div className="help-strip-header">
          <p className="eyebrow">Estamos para ayudarte</p>
          <h2>¿Necesitás ayuda para elegir?</h2>
          <p className="help-strip-sub">Nuestro equipo te asesora sin compromiso.</p>
        </div>
        <div className="help-grid">
          <article className="help-card">
            <div className="help-card-icon help-card-icon--whatsapp">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
              </svg>
            </div>
            <h3>WhatsApp</h3>
            <p>Atención rápida para ventas y consultas. Te respondemos al instante.</p>
            <a
              className="help-card-btn"
              href={buildContactLink("Hola, necesito ayuda para elegir un producto de Manarey.", "Ayuda para elegir producto")}
              target="_blank"
              rel="noreferrer"
            >
              Escribir ahora
          ...
          <article className="help-card help-card--featured">
            <div className="help-card-icon help-card-icon--consult">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
              </svg>
            </div>
            <h3>Consulta personalizada</h3>
            <p>Te ayudamos a encontrar el producto ideal según tu espacio y presupuesto.</p>
            <button className="help-card-btn help-card-btn--primary" onClick={() => navigateTo("contacto")} type="button">
              Ir a contacto
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            </button>
          </article>
          <article className="help-card">
            <div className="help-card-icon help-card-icon--email">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>
              </svg>
            </div>
            <h3>Correo electrónico</h3>
            <p>Envianos tu consulta y te respondemos a la brevedad.</p>
            <a className="help-card-btn" href="mailto:leandromanavella2016@gmail.com">
              Enviar correo
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            </a>
          </article>
      ...
      <footer className="site-footer">
        <div className="footer-top">
          <div>
            ...
            <p className="footer-tagline">Empresa familiar desde 2017 · {storeBranches.length} sucursales en el sur del GBA</p>
          </div>
          {whatsappNumber && (
            <a
