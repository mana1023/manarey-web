        ...
        {activeView === "sobre-nosotros" ? (
          <>
            <section className="content-hero">
              ...
              <h2>Una empresa familiar con mas de 8 anos de trayectoria.</h2>
            </section>
            ...
            <section className="about-story">
              <article className="about-story-text">
                ...
                <p>
                  Con mucho esfuerzo y dedicacion, fuimos creciendo ano a ano. Hoy somos{" "}
