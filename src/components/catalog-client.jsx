        ...
        {activeView === "sobre-nosotros" ? (
          <>
            <section className="content-hero">
              ...
              <h2>Muebleria Manarey — muebles y articulos del hogar.</h2>
            </section>
            ...
            <section className="about-grid">
              <article className="info-card dark">
                <BrandLogo />
                <p>
                  Mas de {storeBranches.length} sucursales en la zona sur del Gran Buenos Aires.
                  Retiro en local o envio coordinado a domicilio.
                </p>
              </article>
